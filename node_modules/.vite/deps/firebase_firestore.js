...
var __PRIVATE_SimpleDb = class {
  ...
  static D() {
    ...
    if (__PRIVATE_SimpleDb.C())
      return true;
    const e = getUA(), t = __PRIVATE_SimpleDb.S(e), n = 0 < t && t < 10, r2 = __PRIVATE_SimpleDb.v(e), i = 0 < r2 && r2 < 4.5;
...
var __PRIVATE_IndexedDbPersistence = class {
  constructor(e, t, n, r2, i, s, o, _, a, u, c = 15) {
    ...
    this.Pi = (e2) => Promise.resolve(), !__PRIVATE_IndexedDbPersistence.D())
